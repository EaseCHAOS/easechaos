            ...
            <footer className="px-4 py-6 ">
                <div className="container flex items-center justify-center p-0">
                    ...
                    <p className="text-xs sm:text-sm dark:text-[#F0F6FC]">
                        Designed by <a className="underline underline-offset-4" href="https://github.com/0xdvc">
                            Abdul-Manan Femanya 
                        </a>, built by <a className="underline underline-offset-4" href="https://github.com/0xdvc">
                            Ohene Neil
